...
public class NativeStructureVolumeIndexTest {
    ...
    public void assembledPiecesBecomeWorldSpacePieceVolumes() {
        ...
        KList<NativeStructureVolume> volumes = NativeStructureVolumeSource.appendPieces(null, STRUCTURE_KEY, start);
    ...
    public void invalidStartsContributeNoVolumes() {
        assertNull(NativeStructureVolumeSource.appendPieces(null, STRUCTURE_KEY, StructureStart.INVALID_START));
        assertNull(NativeStructureVolumeSource.appendPieces(null, STRUCTURE_KEY, null));
    }
    ...
    public void invalidatedIndexReceivesRuntimeRetirementAndDetachesOnUninstall() throws Exception {
        ...
        NativeStructureVolumeSource.Context context = new NativeStructureVolumeSource.Context(
                null, null, null, null, () -> null, () -> null, () -> null);
        NativeStructureVolumeIndex.install(engine,
                new NativeStructureVolumeSource<>(context, IrisStructureVolumePolicy.INSTANCE)::volumesAt);
        try {
    ...
    private static final class CountingResolver implements NativeStructureVolumeIndex.OriginResolver {
        ...
        public KList<NativeStructureVolume> volumesAt(Engine engine, int chunkX, int chunkZ) {
            ...
            return NativeStructureVolumeSource.appendPieces(null, STRUCTURE_KEY, swampHut(chunkX, chunkZ, 4, 6));
        }
    }
