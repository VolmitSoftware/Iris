...
final class DatapackStructureStateFilter {
    ...
    static Optional<AbstractSpreadingStructurePlacement.ExclusionZone> exclusionZone(StructurePlacement placement) {
    ...
    private static StructurePlacement scopePlacement(
        ...
        Optional<AbstractSpreadingStructurePlacement.ExclusionZone> currentZone = exclusionZone(placement);
        ...
        Holder<StructureSet> scopedTarget = scopeHolder(
                ...
                visiting,
                keyIndex);
        Optional<AbstractSpreadingStructurePlacement.ExclusionZone> scopedZone = Optional.empty();
        if (scopedTarget != null) {
            scopedZone = Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(
                    scopedTarget,
    ...
    private static StructurePlacement copyPlacement(
            StructurePlacement placement,
            Optional<AbstractSpreadingStructurePlacement.ExclusionZone> exclusionZone,
