...
public class NMSBindingDatapackStructureScopeTest {
    ...
    public void frequencyOnlyPassLeavesUnrelatedCustomPlacementUntouched() {
        ...
        Holder<StructureSet> custom = structureSetHolder(
                ...
                new UnsupportedPlacement(Optional.of(
                        new AbstractSpreadingStructurePlacement.ExclusionZone(exclusionTarget, 1))),
    ...
    public void frequencyOnlyPassRebindsDependentExclusionTarget() {
        ...
        RandomSpreadStructurePlacement dependentPlacement = new RandomSpreadStructurePlacement(
                ...
                1.0F,
                4567,
                Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(target, 1)),
                32,
                8,
    ...
    public void frequencyOnlyPassRebindsAffectedExclusionCycle() {
        ...
        first.bind(structureSet(
                new RandomSpreadStructurePlacement(
                        ...
                        1.0F,
                        101,
                        Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(second, 1)),
                        32,
                        8,
                        RandomSpreadType.LINEAR),
                "example:first"));
        second.bind(structureSet(
                new RandomSpreadStructurePlacement(
                        ...
                        1.0F,
                        102,
                        Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(first, 1)),
                        27,
                        4,
                        RandomSpreadType.LINEAR),
                "example:second"));
    ...
    public void excludedManagedSetCannotSuppressAnAllowedSetThroughExclusionZone() {
        ...
        RandomSpreadStructurePlacement originalPlacement = new RandomSpreadStructurePlacement(
                ...
                1.0F,
                4567,
                Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(managedSet, 1)),
                32,
                8,
                RandomSpreadType.LINEAR);
        Holder<StructureSet> vanillaSet = structureSetHolder(
    ...
    private static final class KeyedHolder<T> extends Holder.Reference<T> {
    ...
    private static final class UnsupportedPlacement extends AbstractSpreadingStructurePlacement {
        ...
        @Override
        public MapCodec<? extends AbstractSpreadingStructurePlacement> codec() {
            return null;
        }
    }
