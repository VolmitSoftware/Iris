...
public final class IrisPapiExpansion extends VolmitPlaceholderExpansion {
    ...
    public static PlaceholderKeyRegistry registry(IrisPapiState state) {
        ...
        return PlaceholderKeyRegistry.builder()
                ...
                .key("world.biome-custom", state::biomeCustom)
                .key("world.biome-custom-id", state::biomeCustomId)
                .key("world.biome-custom-ids", state::biomeCustomIds)
                .key("world.biome-custom-key", state::biomeCustomKey)
                .key("world.biome-custom-keys", state::biomeCustomKeys)
                .key("world.biome-custom-count", state::biomeCustomCount)
                .key("world.biome-derivative", state::biomeDerivative)
                .key("world.biome-vanilla-derivative", state::biomeVanillaDerivative)
                .key("world.biome-type", state::biomeType)
                .key("world.min-height", state::minHeight)
                .key("world.max-height", state::maxHeight)
                .key("world.height", state::height)
                .key("world.fluid-height", state::fluidHeight)
