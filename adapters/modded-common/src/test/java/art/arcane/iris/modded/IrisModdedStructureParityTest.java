...
public class IrisModdedStructureParityTest {
    ...
    public void visibleCaveBiomeBeginsEightBlocksBelowTheSurface() {
        assertFalse(ModdedBiomePolicy.isUnderground(93, 100));
        assertTrue(ModdedBiomePolicy.isUnderground(92, 100));
        assertTrue(ModdedBiomePolicy.isUnderground(-20, 100));
    }

    @Test
    public void monumentBiomeCubeUsesSurfaceBiomesAtShiftedSeaLevel() {
        assertTrue(ModdedBiomePolicy.isMonumentSurfaceBiomeQuery(50, 29, -256, 306));
        assertFalse(ModdedBiomePolicy.isMonumentSurfaceBiomeQuery(51, 29, -256, 306));
        assertFalse(ModdedBiomePolicy.isMonumentSurfaceBiomeQuery(50, 28, -256, 306));
    }

    @Test
    public void strongholdRingSearchSamplesOneQuartColumnPerChunk() {
        assertEquals(4, ModdedBiomePolicy.horizontalBiomeSearchQuartStep(0, 112));
        assertEquals(1, ModdedBiomePolicy.horizontalBiomeSearchQuartStep(1, 112));
        assertEquals(1, ModdedBiomePolicy.horizontalBiomeSearchQuartStep(0, 111));
    }
    ...
    public void reconciledSpawnUsesOriginAndClampedSurfaceHeight() {
        assertEquals(new NativeBlockPoint(0, 73, 0), ModdedEngineBootstrap.reconciledSpawnPosition(73, -64, 384));
        assertEquals(new NativeBlockPoint(0, -63, 0), ModdedEngineBootstrap.reconciledSpawnPosition(-100, -64, 384));
        assertEquals(new NativeBlockPoint(0, 318, 0), ModdedEngineBootstrap.reconciledSpawnPosition(400, -64, 384));
    }
    ...
    public void biomeResolutionUsesRawPlatformSeedFormula() {
        ...
        assertEquals(expected, ModdedBiomePolicy.biomeResolutionSeed(worldSeed, blockX, blockY, blockZ));
    }
    ...
    public void stackedCustomBiomesUseTheirOwningDimensionNamespace() {
        ...
        assertEquals(
                ...
                ModdedBiomePolicy.customBiomeRef("pack", upper, "Aurora")
        );
        assertFalse(ModdedBiomePolicy.customBiomeRef("pack", host, "Aurora")
                .equals(ModdedBiomePolicy.customBiomeRef("pack", upper, "Aurora")));
    }
    ...
    public void temporaryNaturalBiomeAnswersAreNotMemoized() {
        ...
        assertFalse(ModdedBiomePolicy.isBiomeCacheable(engine, 12, -8));
        when(engine.answersFromNaturalTerrain(12, -8)).thenReturn(false);
        assertTrue(ModdedBiomePolicy.isBiomeCacheable(engine, 12, -8));
    }
    ...
    public void structureStateRejectsBiomesOutsideThePackContract() {
        ...
        assertTrue(ModdedBiomePolicy.isGeneratedBiomeKey("minecraft:deep_ocean", generated));
        assertTrue(ModdedBiomePolicy.isGeneratedBiomeKey("MINECRAFT:DARK_FOREST", generated));
        assertFalse(ModdedBiomePolicy.isGeneratedBiomeKey("minecraft:desert", generated));
        assertFalse(ModdedBiomePolicy.isGeneratedBiomeKey(null, generated));
    }

    @Test
    public void structureBiomeContractRejectsAnEmptyConfiguredSet() {
        IllegalStateException error = assertThrows(IllegalStateException.class,
                () -> ModdedBiomePolicy.requireConfiguredStructureBiomeKeys(Set.of()));
    ...
    public void structureBiomeContractPreservesConfiguredKeysDuringBootstrap() {
        ...
        assertSame(configured, ModdedBiomePolicy.requireConfiguredStructureBiomeKeys(configured));
    }
