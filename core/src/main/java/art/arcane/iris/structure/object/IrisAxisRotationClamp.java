...
public class IrisAxisRotationClamp {
    @Description("Should this axis be rotated at all?")
    ...
    @MinNumber(-360)
    @MaxNumber(360)
    @Description("The minimum angle (from) or set this and max to zero for any angle degrees. Set both to the same non-zero value to force it to that angle only")
    ...
    @MinNumber(-360)
    @MaxNumber(360)
    @Description("The maximum angle (to) or set this and min to zero for any angle degrees. Set both to the same non-zero value to force it to that angle only")
