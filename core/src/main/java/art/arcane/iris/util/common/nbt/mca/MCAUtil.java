...
import art.arcane.volmlib.util.nbt.mca.MCAUtilSupport;
...
public final class MCAUtil {
    ...
    public static String createNameFromChunkLocation(int chunkX, int chunkZ) {
        return MCAUtilSupport.createNameFromChunkLocation(chunkX, chunkZ);
    }
    ...
    public static String createNameFromBlockLocation(int blockX, int blockZ) {
        return MCAUtilSupport.createNameFromBlockLocation(blockX, blockZ);
    }
    ...
    public static String createNameFromRegionLocation(int regionX, int regionZ) {
        return MCAUtilSupport.createNameFromRegionLocation(regionX, regionZ);
    }
    ...
    public static int blockToChunk(int block) {
        return MCAUtilSupport.blockToChunk(block);
    }
    ...
    public static int blockToRegion(int block) {
        return MCAUtilSupport.blockToRegion(block);
    }
    ...
    public static int chunkToRegion(int chunk) {
        return MCAUtilSupport.chunkToRegion(chunk);
    }
    ...
    public static int regionToChunk(int region) {
        return MCAUtilSupport.regionToChunk(region);
    }
    ...
    public static int regionToBlock(int region) {
        return MCAUtilSupport.regionToBlock(region);
    }
    ...
    public static int chunkToBlock(int chunk) {
        return MCAUtilSupport.chunkToBlock(chunk);
    }

    public static MCAFile newMCAFile(File file) {
        int[] coords = MCAUtilSupport.parseRegionCoordinates(file);
        return new MCAFile(coords[0], coords[1]);
    }
}
