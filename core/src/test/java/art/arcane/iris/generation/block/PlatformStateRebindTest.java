...
public class PlatformStateRebindTest {
    ...
    private static final List<String> CONVERTED = List.of(
            "art.arcane.iris.generation.stage.IrisDimensionStackActuator",
            "art.arcane.iris.generation.stage.IrisTerrainNormalActuator",
            "art.arcane.iris.generation.stage.IrisPerfectionModifier",
            "art.arcane.iris.generation.stage.IrisPostModifier",
            "art.arcane.iris.generation.biome.IrisBiomeLayerGenerator",
            "art.arcane.iris.studio.generation.BiomeBuffetGenerator",
            "art.arcane.iris.generation.mantle.EngineMantle",
            "art.arcane.iris.generation.chunk.ChunkDataHunkHolder");
