...
public class MantleHydrologyCaveVoxelViewTest {
    ...
    public void mapsCarvedAndStoredMatterAndLoadsEachChunkOnce() {
        ...
        NativeBlockState incompatibleFluid = mock(NativeBlockState.class);
        NativeBlockState lavaBlock = mock(NativeBlockState.class);
        ...
        doReturn(incompatibleFluid).when(mantle).get(3, 20, 0, NativeBlockState.class);
        doReturn(lavaBlock).when(mantle).get(4, 20, 0, NativeBlockState.class);
        doReturn(solid).when(mantle).get(5, 20, 0, NativeBlockState.class);
