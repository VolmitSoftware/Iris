...
public class SchemaBuilderParityTest {
    ...
    @Description("Registry dependent model.")
    public static class RegistryModel {
        @Description("Potion field.")
        @RegistryListPotionEffect
        private String potion = "";

        @Description("Enchant field.")
